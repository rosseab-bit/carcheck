"""
Django settings for carcheck project.
...
SECRET_KEY = 'django-insecure-au!b*@!=n_sd)wcz13ygbp0qcy1$9t4yzu#t8&+c^*@2y^ljy7'
...
WSGI_APPLICATION = 'carcheck.wsgi.application'
